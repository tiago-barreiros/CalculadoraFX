...
# Registadora Comercial

<table>
<tr>
<td>

> Criação de uma calculadora do tipo registadora comercial, com interface dinamicamente ajustável. Neste
exercício, além da introdução de novas componentes GUI, do JavaFX, iremos respeitar estritamente a
abordagem Model-View-Controller (MVC) na concepção da nossa aplicação.
...
Após a entrega deste projeto ficará publico :  https://github.com/tiago-barreiros/CalculadoraFX
